 ...
 */
function treeInitial (nodesArray, pathName, treeRoot, orphanList) {
...
exports.treeInitial = treeInitial;
 ...
 * 
 */
function treePushNode(node, child) {
...
exports.treePushNode = treePushNode;
 ...
 * 
 */
function treeUpdateNodePath(node, parentpath) {
...
exports.treeUpdateNodePath = treeUpdateNodePath;
 ...
 *  
 */
function treeRenameNode(node, newname) {
    // console.log('treePushNode: ', node, child);
    // console.log(node.__path.split('.').length, child.__path.split('.').length);
    // console.log(child.__path.indexOf(node.__path));
    const pathstr = node.__path.split('.');
...
exports.treeRenameNode = treeRenameNode;
